...
\bottomrule
\end{tabular}
\caption{Benchmark matrix. All ten canonical scenario files run green in the scenario and determinism CI gates; per-figure CSV filenames and data SHA-256 values are added when the figure-regeneration pipeline lands.}
\end{table}
...
\begin{itemize}[leftmargin=*]
    ...
    \item benchmark raw-data paths --- \emph{pending} (figure pipeline);
    \item figure regeneration commands --- \emph{pending} (figure pipeline).
\end{itemize}
