...
\bottomrule
\end{tabular}
\caption{Benchmark matrix. All eleven canonical scenario files run green in the scenario and determinism CI gates; the figure-regeneration pipeline records each plotted scenario's telemetry-CSV SHA-256 in \texttt{docs/paper/figures/manifest.yaml}.}
\end{table}
